...
//console.log("Thomas saved");
	...
	getScores:function() {
		...
		op+="<input type='text' name='firstname' value='"+yoodoo.user.firstname+"' />";
		op+="<input type='text' name='lastname' value='"+yoodoo.user.lastname+"' />";
	...
	analyze:function() {
		...
		if(display_dooit.value.traits.invalid) {
			...
			for(var k in display_dooit.value.traits.greyZone) {
				...
				if (rep) {
					rep.questions.push('Describe any situation where you felt you had gnoe too far in your behaviour?');

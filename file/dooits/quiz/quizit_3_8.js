...
//console.log(this.nextResponse);
		...
		this.protect=function() {
			...
			$(this.hide).css({position:"absolute",width:'100%',height:'100%',padding:0,top:0,left:0,background:'rgba(255,255,255,0.9)'}).addClass('hideAndProtect');
...
quizit.answeredQuestion.respond();
			...
			$('.yd_nextButton').unbind("click").slideUp();

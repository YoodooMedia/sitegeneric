...
console.log(time);
	...
	field_xport_container:function(d) {
		...
		//console.log(this.data.structure[d[di]].value.type,tmp);
							...
							if (multy && di==0) {
								if(typeof(this.data.structure[d[0]].paragraph)!="undefined" && this.data.structure[d[0]].paragraph!="") {
									...
									if (!styled) {
										...
										//tmp[t].splice(0,0,this.data.structure[d[0]].title);

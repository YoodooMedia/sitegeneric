...
//console.log(display_dooit.value.reportFunction);
		...
		dooit.displayed=function() {if (display_dooit!==undefined && display_dooit.layout_buttons!==undefined) {
...
//alert("Pause");
	...
	set_button:function(o) {
		if (!$(o).hasClass('disabled')) {
			...
			for(var j=0;j<display_dooit.value[ans.id][ans.answer].length;j++) {
				if (display_dooit.data.structure[q].value.option[j]!==null && display_dooit.value[ans.id][ans.answer][j]!==null && j!=si) display_dooit.value[ans.id][ans.answer][display_dooit.data.structure[q].value.option[j].index]='0';
			}

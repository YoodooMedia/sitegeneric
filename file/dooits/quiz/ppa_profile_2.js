...
var ppa_profile={
	...
	initGraph:function() {
		...
		if (this.structure.main.selfimage===false) {
			...
			img1.src='http://hub.thomasinternational.net/Handlers/DISC/Disc.ashx?Width='+w+'&Height='+h+'&D='+this.value.ppa.DISCGraph1.D+'&I='+this.value.ppa.DISCGraph1.I+'&S='+this.value.ppa.DISCGraph1.S+'&C='+this.value.ppa.DISCGraph1.C+'&GraphStyle=0&GraphType=0&ReportingNorms=0';
			...
			img2.src='http://hub.thomasinternational.net/Handlers/DISC/Disc.ashx?Width='+w+'&Height='+h+'&D='+this.value.ppa.DISCGraph2.D+'&I='+this.value.ppa.DISCGraph2.I+'&S='+this.value.ppa.DISCGraph2.S+'&C='+this.value.ppa.DISCGraph2.C+'&GraphStyle=0&GraphType=1&ReportingNorms=0';
		...
		img3.src='http://hub.thomasinternational.net/Handlers/DISC/Disc.ashx?Width='+w+'&Height='+h+'&D='+this.value.ppa.DISCGraph3.D+'&I='+this.value.ppa.DISCGraph3.I+'&S='+this.value.ppa.DISCGraph3.S+'&C='+this.value.ppa.DISCGraph3.C+'&GraphStyle=0&GraphType=2&ReportingNorms=0';

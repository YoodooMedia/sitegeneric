...
//((this.data.structure[d].paragraph=='')?'Undefined':sumText);
	...
	field_editor:function(d) {
		...
		switch(this.data.structure[d].value.type) {
			case "paragraph":
				op+="<div class='field_info'>"+ins+"<div id='paragraph"+d+"' class='paragraph' onclick='constructor_dooit.edit_paragraph(this,"+d+")''>"+this.data.structure[d].paragraph+"</div>"+this.type_selector(this.data.structure[d].value.type)+this.type_help[this.data.structure[d].value.type]()+"</div>";
			break;
			case "slider":
...
//console.log(this.fields_content);
	...
	edit_paragraph:function(o,d) {
		...
		o.parentNode.parentNode.field_name='paragraph';
...
//console.log(inst.getContent());
				if (typeof(inst)!="undefined") {
					...
					txt=txt.replace(/\n/g,'');
					txt=txt.replace(/\r/g,'');
					this.data.structure[this.open_editor.question][this.open_editor.field_name]=txt;

	...
	type_output:{
		...
		textarea:function(d,val,a) {
			...
			for(var i=0;i<val.option.length;i++) {
				...
				ins+="<div class='item'><span class='label'>"+val.option[i].title+"</span><textarea style='height:auto;"+style+"' rows="+rows+" onkeyup='display_dooit.set_value(\""+d+"\","+i+",this.value,"+a+");'>"+display_dooit.valueDecode(display_dooit.value[d][a][i]?display_dooit.value[d][a][i]:"")+"</textarea></div>";
			}
			return ins;
		},

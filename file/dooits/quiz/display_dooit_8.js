	...
	type_output:{
		...
		numeric:function(d,val,a) {
			...
			if (val.option.length==1) {
				for(var i=0;i<val.option.length;i++) ins+="<input type='text' style='text-align:right' onkeydown='return display_dooit.type_validate.numeric(this,event);' onkeyup='display_dooit.set_value(\""+d+"\","+i+",this.value,"+a+");' onblur='display_dooit.set_value(\""+d+"\","+i+",this.value,"+a+");' value='"+(display_dooit.value[d][a][i]?display_dooit.value[d][a][i]:"")+"' />";
			}else{
				for(var i=0;i<val.option.length;i++) ins+="<div class='item'><span class='label'>"+val.option[i].title+"</span><input type='text' onkeydown='return display_dooit.type_validate.numeric(this,event);' onkeyup='display_dooit.set_value(\""+d+"\","+i+",this.value,"+a+");' onblur='display_dooit.set_value(\""+d+"\","+i+",this.value,"+a+");' value='"+(display_dooit.value[d][a][i]?display_dooit.value[d][a][i]:"")+"' /></div>";
			}
			return ins;
		},

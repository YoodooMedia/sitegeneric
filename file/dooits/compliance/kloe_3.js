...
var kloe = {
	...
	standardizeItem: function(obj) {
		...
		obj.render = function() {
			...
			this.button = $(yoodoo.e("button")).attr("type", "button").addClass("item subsection").append($(yoodoo.e("b")).html(this.title)).append($(yoodoo.e("div")).html(this.shortDescription));
			if (kloe.templater) {

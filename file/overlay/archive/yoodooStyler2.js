var yoodooStyler = {
    ...
    build_styles: function () {
        ...
        if (yoodoo.styles.backgroundImage !== undefined && yoodoo.styles.backgroundImage !== null && yoodoo.styles.backgroundImage != "") {
            ...
            newcss['#yoodooWidget, #yoodooContainerContent'] = {
                'background-image': 'url(' + yoodoo.styles.backgroundImage + ') !important',
        ...
        newcss['.' + yoodoo.class_prefix + '_toolbar a:hover, #yoodooWidget.isMouse .overlayFooter button.footerbutton:hover'] = {
        ...
        newcss['.' + yoodoo.class_prefix + '_toolbar button,#yoodooWidget.isMouse .overlayFooter button.done:hover'] = {
        ...
        newcss['.' + yoodoo.class_prefix + '_toolbar button,#yoodooWidget .overlayFooter>*>button.on'] = {
            ...
            'background': yoodooStyler.rgbToHex(yoodoo.styles.toolbar.button.on)
        };

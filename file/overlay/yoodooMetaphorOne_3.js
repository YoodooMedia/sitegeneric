...
yoodoo.openSearch = function(){
    if(yoodoo.keywordSearch===true)yoodoo.search.renderDialog();
};
yoodoo.closeSearch = function(){
    if(yoodoo.keywordSearch===true)yoodoo.search.closeDialog();
};
...
yoodoo.welcome = function() {
    ...
    if(yoodoo.keywordSearch!== undefined && yoodoo.keywordSearch===true){
        var search = yoodoo.e("button");
        $(search).attr("type", "button").addClass("search cta").css({"position":"absolute", "right":"5px"}).append(yoodoo.icons.get('search', 20, 20)).bind("click", function() {
            yoodoo.openSearch();
        });
        $(yoodoo.welcomeContainers.content).append(search);
    }
...
yoodoo.loadingDiv=function() {
	return $(yoodoo.e("div")).addClass("loading").append(
		$(yoodoo.e("div")).append(yoodoo.e("div"))
	);
};

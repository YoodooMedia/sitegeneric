yoodoo.ui = {
    ...
    text: function(args) {
        ...
        this.processRender = function(value) {
            ...
            if (this.settings.className.value !== '' && this.settings.className.value !== undefined) $(this.container).addClass(this.settings.className.value);
	...
	textarea: function(args) {
	    this.settings = {
	        ...
	        fixedHeightToRow: {
	            title: 'Fix the height to the number of rows defined',
	            type: 'boolean',
	            value: false
	        },
	        heightToParent: {
	            title: 'Set the height to 100% of the parent height',
	            type: 'boolean',
	            value: false
	        },
	        editableDiv: {
	            title: 'Render the textarea as a editable div',
	            type: 'string',
	            value: ''
	        },
	        fullscreen: {
	        ...
	        onfullscreenIn: {
	            title: 'Callback function on fullscreen',
	            type: 'function',
	            value: function(e, o) {}
	        },
	        onfullscreenOut: {
	            title: 'Callback function on fullscreen out',
	            type: 'function',
	            value: function(e, o) {}
	        },
	        onFocus: {
	            title: 'Function called on focus of the editable div',
	            type: 'function',
	            value: function(e, o) {}
	        },
	        onBlur: {
	            title: 'Function called on blur of the editable div',
	            type: 'function',
	            value: function(e, o) {}
	        },
	        editableClass: {
	            title: 'Add class to the editable div',
	            type: 'integer',
	            value: 0
	        },
	        required: {
	    ...
	    this.processRender = function(value) {
	        ...
	        if (!this.settings.editableDiv.value) {
	            ...
	            me.checksize(false);
	            if (this.settings.fixedHeightToRow.value) {
	                $(this.input).unbind('blur focus');
	                $(this.inputSurround).css('height', 'auto');
	                $(this.input).css({
	                    height: 'auto',
	                    overflow: 'auto',
	                    position: 'relative',
	        ...
	        } else if (this.settings.editableDiv.value) {
	            $(this.container).css({
	                position: 'relative',
	                height: '100%',
	                'border-radius': '10px'
	            ...
	            this.editableDiv = $(yoodoo.e("div")).attr('contenteditable', true).css({
	                ...
	                'border-radius': '10px',
	                'margin-top': ' 1px'
	            }).addClass(this.settings.editableClass.value);
	            ...
	            this.editableDiv.bind('mouseup keyup', function(e) {
	                selection = window.getSelection();
	                var focusNode = selection.focusNode;
	                while (focusNode !== document.body && focusNode !== this) focusNode = focusNode.parentElement;
	                selected = {
	                ...
	                me.value = this.value;
	                me.input.value = this.value;
	                me.settings.onchange.value.apply(me, [e]);
	            }).bind('focus', function(){
	            	me.settings.onFocus.value();
	            }).bind('blur', function(){
    ...
    selectbox: function(args) {
        this.settings = {
            ...
            className: {
                title: 'add class to the container',
                type: 'text',
                value: ''
            },
            required: {
    ...
    selectOptionGroup: function(args) {
        ...
        yoodoo.ui.standard(this, args);
        this.processRender = function(value) {
            var op = $(yoodoo.e("optgroup")).prop("disabled", this.settings.disabled.value);
			if (this.settings.label.value!='') op.attr("label", this.settings.label.value);
            if (this.settings.randomAnswers.value === true)
                this.options = this.shuffle(this.options);
            this.options.forEach(function(optionValue) {
    ...
    selectOption: function(args) {
        ...
        this.processRender = function(value) {
            ...
            $(this.element).html(this.settings.label.value);
			//.text = this.settings.label.value;
    ...
    tree: function(args) {
        ...
        this.screenObject = function(tree, schema) {
            ...
            this.tree = tree;
            this.schema = schema;
            this.container = $(yoodoo.e("div")).addClass("tree_screen verticalAlign");
            this.draw = function() {
                var source = me;
                this.empty();
            ...
            this.gotoScreen = function(key, complete) {
                if (this.screens[key] !== undefined) {
                    ...
                    $(this.container).animate({
                        ...
                        $(this).empty().append(me.screens[key].render());
                        yoodoo.ui.update();
                        $(this).animate({
                            opacity: 1
                        }, 300, function() {
        ...
        this.build = function() {
            ...
            if (this.settings.pages.value instanceof Array) {
                ...
                for (var p in this.settings.pages.value) {
                    ...
                    this.addPage(this.settings.pages.value[p]);
                }
            }
    ...
    dialog: function(args) {
        ...
        this.timeout = null;
        this.render = function() {
            this.dialogueBox = $(yoodoo.e("div")).addClass(this.settings.className.value).html(this.settings.html.value).css(this.settings.css.value).css({
		'max-height':(yoodoo.option.height-60)+'px'
		});
            var me = this;
    ...
    rules: {
        ...
        standardize: function(obj, source, args) {
            obj.source = source;
            var currentTags = (yoodoo.metaphor == 1) ? yoodoo.bookcase.tags : yoodoo.sessions._tags;
            obj.event = 'onchange';
